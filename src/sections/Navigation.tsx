...
import { Menu, X, ChevronDown, Wine, Home, BookOpen, Newspaper, Users, Mail, Grape, Landmark } from 'lucide-react';
import { navigationConfig } from '../config';

// Icon lookup map for dynamic icon resolution from config strings
const iconMap: Record<string, React.ComponentType<{ className?: string }>> = {
  Home, BookOpen, Newspaper, Users, Mail, Grape, Wine, Menu, X, ChevronDown, Landmark,
};
...
export function Navigation() {
  ...
  // Closes the mobile menu / open dropdown after a navigation link is used
  const closeMenus = () => {
              ...
              >
                ...
                {link.dropdown && (
                  <div
                    ...
                    role="menu"
                  >
                    <div className="bg-wine-800/95 backdrop-blur-md rounded-md overflow-hidden min-w-[240px] border border-white/10">
